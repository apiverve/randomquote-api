...
namespace APIVerve.API.RandomQuote
{
    /// <summary>
    ...
    /// <summary>
    /// Client for the RandomQuote API
    /// </summary>
    public class RandomQuoteAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/randomquote";
        ...
        public RandomQuoteAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RandomQuoteAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RandomQuoteAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RandomQuoteQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RandomQuoteQueryOptions options)
        {
        ...
        public ResponseObj Execute(RandomQuoteQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RandomQuoteQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RandomQuoteQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RandomQuoteQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RandomQuoteQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RandomQuoteQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RandomQuoteQueryOptions options)
        {
